<x-layouts.guest title="Sign In">
    <div class="auth-wrapper" x-data="{ loading: false, showPwd: false }">
        <div class="auth-card">
            <!-- Logo -->
            <div class="auth-logo">
                <a href="{{ route('home') }}">
            ...
            <form method="POST" action="{{ route('login') }}" @submit="loading = true">
                ...
                <div class="auth-row-between" style="margin-bottom: 0.25rem;">
                ...
                <button type="submit" class="auth-submit" :class="loading && 'is-loading'" :disabled="loading">
                    ...
                    <span x-show="loading" x-cloak><span class="auth-spinner"></span> Signing in...</span>
                </button>
            </form>
